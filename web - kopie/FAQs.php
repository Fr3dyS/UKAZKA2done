	...
	<section class="section-padding gray-bg">
		<div class="container">
			<div class="section-header text-center">
				<h2>FAQs - Frequently Asked Questions <span>Často kladené otázky</span></h2>
				...
				<p>Suspendisse nisl. Aenean fermentum risus id tortor. Pellentesque sapien. Duis pulvinar. Suspendisse nisl. Nam sed tellus id magna elementum tincidunt. Praesent id justo in neque elementum ultrices. Fusce consectetuer risus a nunc. Aliquam id dolor. Integer imperdiet lectus quis justo. Donec iaculis gravida nulla. Phasellus rhoncus. Phasellus faucibus molestie nisl. Etiam dictum tincidunt diam. Donec ipsum massa, ullamcorper in, auctor et, scelerisque sed, est. Pellentesque arcu. Nunc auctor. Pellentesque ipsum.</p>
			</div>
		</div>
	</section>
		<?php
